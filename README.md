...
```bash
# Download the AppImage (v0.2.8)
wget https://github.com/MedGm/Ollie/releases/download/v0.2.8/Ollie_0.2.8_amd64.AppImage

# Make it executable
chmod +x Ollie_0.2.8_amd64.AppImage

# Run it
./Ollie_0.2.8_amd64.AppImage
```
